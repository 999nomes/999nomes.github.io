...
Construída com **100% Front-end (Vanilla HTML, CSS, JS)**, garantindo que seja ultraleve, rápida e que possa rodar offline sem a necessidade de um servidor backend pesado.
...
3. Clique duas vezes no arquivo `index.html` para abri-lo no seu navegador (Chrome, Edge, Firefox, Safari).
4. **Pronto!** O aplicativo já está funcionando.
