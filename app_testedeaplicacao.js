  ...
  <div class="pt-20 pb-8 px-4 max-w-7xl mx-auto">
    ...
    <div id="calculator-page" class="page-content">
      ...
      <table id="tabelaprod" class="min-w-full bg-gray-800 rounded-lg overflow-hidden shadow-xl mb-4">
        <thead>
          <tr class="bg-gray-700 text-sm sm:text-base">
            ...
            <th class="px-2 py-1">Preço Unit.</th>
      ...
      <div class="mt-4 flex flex-col sm:flex-row gap-2 justify-center sm:justify-start">
        ...
        <button id="identifyButton" class="bg-purple-600 hover:bg-purple-700 px-6 py-2 rounded-lg font-bold transition transform hover:scale-105 shadow-lg">Identificar com Câmera ✨</button>
    ...
    <div id="shopping-list-page" class="page-content hidden">
      ...
      <div class="bg-gray-800 p-4 rounded-lg mb-6 shadow-xl">
        <h2 class="text-lg font-semibold mb-2">Gerar Lista com ✨ Gemini</h2>
        <p class="text-sm text-gray-400 mb-3">Insira um tema e deixe a IA gerar a lista para você.</p>
        <div class="flex flex-col sm:flex-row gap-2">
          ...
          <div class="flex gap-2 w-full sm:w-auto">
            <button id="generate-list-button"
              class="bg-purple-600 hover:bg-purple-700 text-white px-4 py-2 rounded-lg font-bold transition w-full sm:w-auto">Gerar Lista ✨</button>
            <button id="instructions-button"
              class="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-bold transition w-full sm:w-auto">Instruções 📘</button>
          </div>
        </div>
      </div>
      ...
      <table id="shopping-list-table" class="min-w-full bg-gray-800 rounded-lg overflow-hidden shadow-xl">
        <thead class="bg-gray-700 text-sm sm:text-base">
          <tr>
            ...
            <th class="px-2 py-1 text-left">Valor Unitário</th>
    ...
    <div id="instructions-modal" class="fixed inset-0 bg-black bg-opacity-75 hidden flex items-center justify-center z-50">
      <div class="bg-gray-900 text-white p-8 rounded-lg w-11/12 sm:w-96 shadow-2xl relative border border-gray-700">
        ...
        <ol class="list-decimal ml-5 space-y-3 text-sm text-gray-300">
          ...
          <li>Crie uma nova chave e copie o código gerado.</li>
    ...
    <div id="product-details-modal" class="fixed inset-0 bg-black bg-opacity-75 hidden flex items-center justify-center z-50">
      <div class="bg-gray-900 text-white p-8 rounded-lg w-11/12 sm:w-96 shadow-2xl relative border border-gray-700">
        ...
        <div class="space-y-4">
          ...
          <div>
            <label class="block mb-1 text-sm text-gray-400">Preço Unitário (R$):</label>
        ...
        <div class="flex justify-end gap-3 mt-6">
          <button id="add-to-list-button" class="bg-blue-600 hover:bg-blue-700 px-5 py-2 rounded-lg font-bold transition">Adicionar à Lista</button>
  ...
  <script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        completedCheckbox.addEventListener('change', (event) => {
          ...
          if (event.target.checked) {
            if (productInput.value.trim() && unitPriceInput.value.trim()) {
              ...
              showMessage("Preencha o nome e o valor antes de adicionar à lista.", 'error');
      ...
      function addProductToShoppingListFromCalculator(productName, productPrice) {
        ...
        if (exists) {
          showMessage("Produto já adicionado à lista de compras.", 'info');
          return;
        }
        ...
        showMessage("Produto adicionado à lista de compras!");
      }
      ...
      async function identifyProductWithGemini(base64Data) {
        ...
        const payload = {
            contents: [{
                parts: [
                    { text: "Identifique o nome do produto e a marca na imagem. Responda em JSON com o formato: {\"product\":\"Nome do Produto\", \"brand\":\"Marca\"}. Se não conseguir identificar, use o nome \"Produto Desconhecido\" e a marca \"Marca Desconhecida\"." },
        ...
        try {
            ...
            const result = await response.json();
            const jsonContent = result.candidates?.[0]?.content?.parts?.[0]?.text;
            if (!jsonContent) throw new Error("Nenhum conteúdo de imagem retornado");
            ...
            console.error("Erro na identificação da imagem:", e);
      ...
      captureButton.addEventListener('click', async () => {
          ...
          if (identifiedProduct) {
              ...
              showMessage("Não foi possível identificar o produto. Tente novamente.", 'error');
          }
      });
      ...
      cancelDetailsButton.addEventListener('click', () => {
          productDetailsModal.classList.add('hidden');
          showMessage("Adição de produto cancelada.", 'info');
      });
